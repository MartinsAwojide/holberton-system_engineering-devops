...
The linked documentation is to Puppet 3.8 because the 3.4 documentation has been archived and is therefore more challenging to navigate. If you would like to upgrade anyway, [click here](https://medium.com/@Joachim8675309/installing-puppet-5-427ca7a68f02) (this will not affect how your code is checked). [Puppet 5 Docs](https://puppet.com/docs/puppet/5.5/puppet_index.html)
