...
### [0. Double the number of webservers mandatory](./0-custom_http_response-header)
...
### [2. Add a custom HTTP header with Puppet #advanced](./2-puppet_custom_http_response-header.pp)
